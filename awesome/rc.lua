...
beautiful.init(awful.util.getdir("config") .. "/themes/" .. selected_theme .. "/theme.lua")
...
--
-- For dialogs that are difficult to get WM_CLASS of:
-- watch -n 1 'wmctrl -l | head -n1 | cut -f1 -d\  | xargs xprop WM_CLASS -id'
awful.rules.rules = {
    ...
    { rule_any = { class = {"MPlayer", "pinentry", "gimp", "Plugin-container", "Steam", "libreoffice-writer", "CvbApp", "TopLevelShell", "MATLAB R2015b - academic use", "Spread0r", "Pinentry-gtk-2"}},
